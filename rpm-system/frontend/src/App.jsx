...
const createApi = (getToken, refreshTokenFn, logout) => {
  ...
  return {
    ...
    coachChatStream: (id, body) => authFetch(`${API_BASE}/coaches/${id}/chat`, { method: 'POST', body: JSON.stringify(body) }),
    coachRemember: (id, transcript) => authFetch(`${API_BASE}/coaches/${id}/remember`, { method: 'POST', body: JSON.stringify({ transcript }) }).then(r => r.json()),
